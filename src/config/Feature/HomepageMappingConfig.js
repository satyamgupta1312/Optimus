...
export const WIDGET_EDITOR_ROUTES = {
    ...
    single_product_row: { editor: 'SingleProductRow', variant: 'standard', label: 'Single Product Row (Standard)' },
    single_product_row_v2: { editor: 'SingleProductRow', variant: 'optimized', label: 'Single Product Row (Optimized)' },
    multimedia_single_product_row: { editor: 'SingleProductRow', variant: 'multimedia', label: 'Single Product Row (Multimedia)' },
    multimedia_single_product_row_v2: { editor: 'SingleProductRow', variant: 'multimedia-optimized', label: 'Single Product Row (Multimedia Optimized)' },
    double_product_row: { editor: 'SingleProductRow', variant: 'double-standard', label: 'Double Product Row (Standard)' },
    double_product_row_v2: { editor: 'SingleProductRow', variant: 'double-optimized', label: 'Double Product Row (Optimized)' },
    multimedia_double_product_row: { editor: 'SingleProductRow', variant: 'double-multimedia', label: 'Double Product Row (Multimedia)' },
    multimedia_double_product_row_v2: { editor: 'SingleProductRow', variant: 'double-multimedia-optimized', label: 'Double Product Row (Multimedia Optimized)' },
...
export const EMULATOR_WIDGET_COMPONENTS = {
    ...
    single_product_row: { component: 'SingleProductRow', displayAs: 'Horizontal product scroll (1 row)' },
    single_product_row_v2: { component: 'SingleProductRow', displayAs: 'Horizontal product scroll (1 row, optimized)' },
    double_product_row: { component: 'SingleProductRow', displayAs: '2-row product scroll' },
    double_product_row_v2: { component: 'SingleProductRow', displayAs: '2-row product scroll (optimized)' },
    multimedia_single_product_row: { component: 'SingleProductRow', displayAs: 'Product scroll + background media' },
    multimedia_single_product_row_v2: { component: 'SingleProductRow', displayAs: 'Product scroll + background media (optimized)' },
    multimedia_double_product_row: { component: 'SingleProductRow', displayAs: '2-row product scroll + background media' },
    multimedia_double_product_row_v2: { component: 'SingleProductRow', displayAs: '2-row product scroll + background media (optimized)' },
};
