 ...
 * Allows users to fetch widgets from CMS API or Mirror (ClickHouse)
 */
export default function FetchWidget({ onWidgetFetched }) {
    ...
    // Map ClickHouse widget_type values to app-recognized types
    const typeNormalize = {
    ...
    return (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3">
            ...
            <div className="mt-2 text-xs text-gray-500">
                {source === 'db'
                    ? 'Search submitted widgets from Mirror (ClickHouse) by slug or title'
