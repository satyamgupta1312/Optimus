...
export const SCREEN_REGISTRY = [
    ...
    },
    {
        ...
        purpose: 'View all widgets from Supabase database, scoped by current environment. Shows env badge (PROD/UAT).',
        props: ['onClose'],
    ...
    },
    {
        ...
        purpose: 'Manage states/cities for state-wise product mapping. Backend-persisted via Location model (Supabase). Shared across team.',
        props: ['onClose'],
        state: ['search', 'locations', 'loading', 'toggling', 'showCustomForm', 'customForm', 'creating'],
        context: [],
        dataSource: 'LocalApiService.getLocations() — Location model in Supabase DB',
        isNew: false,
    },
    {
        id: 'deploy_status',
...
export const INTEGRATION_POINTS = {
    ...
    StateManagerModal: { context: [], service: 'LocalApiService.getLocations/toggleLocation/createLocation/deleteLocation — Location model in Supabase' },
